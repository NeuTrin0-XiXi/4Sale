...
const Home = () => {
  ...
  <div class="carousel-indicators ">
    ...
    <br /><br /><br />
    {/* ______________________________________ */}
    <div class=" container-fluid album py-5 bg-light homeTileBox">
    <div class="container bigContainer" >
      <div className = " container-fluid tileGroupBox " >
        <span ><h4><u>Recently added</u></h4></span><br />
      ...
      <br /><br />      <div className = "container-fluid tileGroupBox " >
        <span ><h4><u>Stationary</u></h4></span><br />
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
